...
4. package_and_validate_release_archive.sh now runs pre-build local proof integrity checks:
...
5. Repo reality wording now reflects partial valid-time support and avoids false "missing valid_from/valid_to" claims.
