#!/usr/bin/env python3
"""Compile and run safety monitor behavioral simulation."""
...
REPORT_JSON = PROJECT_ROOT / "reports" / "safety_monitor_sim_summary.json"
REPORT_MD = PROJECT_ROOT / "reports" / "safety_monitor_sim_summary.md"
...
def main() -> int:
    ...
    out = build_dir / "tb_safety_monitor.vvp"
    compile_proc = run(
        [
            "iverilog",
            "-g2012",
